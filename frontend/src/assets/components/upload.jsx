...
export default function Homepage() {
  ...
  const handleUpload = () => {
    ...
    axios
      .post("https://help-a-pet-backend.onrender.com/predict", formData, {
        headers: {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-customBg">
      <h1 className="text-4xl font-bold mb-4">Upload Image</h1>
